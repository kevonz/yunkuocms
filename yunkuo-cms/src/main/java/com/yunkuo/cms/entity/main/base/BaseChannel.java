...
public abstract class BaseChannel  implements Serializable {
  ...
  //  private int hashCode = Integer.MIN_VALUE;
   ...
   // @OneToMany//(mappedBy="cmsChannel")
    ...
    public void setAttr(List<CmsChannelAttr> attr) {
        this.attr = attr;
    }

    //bi-directional one-to-one association to CmsChannelTxt
    /*
    @OneToMany(fetch=FetchType.EAGER,cascade=CascadeType.ALL) //(mappedBy="cmsChannel")
    @JoinTable(
